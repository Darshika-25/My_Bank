...
class BankAccounts {
    ...
    withdraw(userAmount) {
        if (this.balance >= userAmount) {
            ...
            console.log(chalk.cyanBright(`Amount Withdrawn : $${userAmount}, Remaining Balance : $${this.balance}`));
        }
        else {
    ...
    deposit(userAmount) {
        ...
        this.balance += userAmount;
        console.log(chalk.cyanBright(`Deposit Amount : $${userAmount}, Remaining Balance : $${this.balance}`));
    }
...
async function service() {
    while (true) {
        ...
        const customer = customerManager.find((customer) => customer.account.accountNumber === accountNumber);
        if (customer) {
            console.log(chalk.bold.magentaBright(`Welcome ${customer.firstName} ${customer.lastName} to our Bank!`));
            ...
            switch (action) {
                case "Withdraw":
                    ...
                    if (!withdrawAmount)
                        return console.log("please provide an amount");
            ...
            console.log(chalk.bgRedBright("Customer not found! Please enter a valid account number!"));
        }
    }
}
